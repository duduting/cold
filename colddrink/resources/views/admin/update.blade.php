...
<body>
    ...
    <div class="formtitle"><span>修改会议室</span></div>
    
    <form action="update_room" method="post">
        @foreach($data as $key=>$val)
            <ul class="forminfo">
            <li><label>会议室名称：</label><input name="room_name" type="text" value="{{$val->room_name}}" class="dfinput" /></li>
            <li><label>会议室地址：</label><input name="room_address" type="text" value="{{$val->room_address}}" class="dfinput" /></li>
            ...
            <li><label>设备清单：</label><input name="facility" type="text" value="{{$val->facility}}" class="dfinput" /></li>
