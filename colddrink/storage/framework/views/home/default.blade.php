...
<!-- <base href="http://localhost/public/home" /> -->
...
<div class="mainmenu">
  <ul>
    <li>
      <div class="menubtn"><a href="indexs">
        <div class="menuimg"><img src="weixin/home.png" /></div>
        <div class="menutitle">首页</div>
        </a> </div>
    </li>
    <li>
      <div class="menubtn"><a href="introduce">
        <div class="menuimg"><img src="weixin/about.png" /></div>
        <div class="menutitle">公司简介</div>
        </a> </div>
    </li>
    <li>
      <div class="menubtn"><a href="brand">
        <div class="menuimg"><img src="weixin/brand.png" /></div>
        <div class="menutitle">品牌诠释</div>
        </a> </div>
    </li>
    <li>
      <div class="menubtn"><a href="album">
        <div class="menuimg"><img src="weixin/product.png" /></div>
        <div class="menutitle">产品相册</div>
        </a> </div>
    </li>
    <li>
      <div class="menubtn"><a href="family">
        <div class="menuimg"><img src="weixin/join.png" /></div>
        <div class="menutitle">招商加盟</div>
        </a> </div>
    </li>
    <li>
      <div class="menubtn"><a href="connect">
...
<script type="text/javascript">
            ...
            "tTitle": "我装酷,我自恋; 我为自己代言!",
            "tContent": "★80的，我和你一样和别人不一样；★",
            "fTitle": "我装酷,我自恋; 我为自己代言!",
            "fContent": "★80的，我和你一样和别人不一样；★",
            "wContent": "★80的，我和你一样和别人不一样；★" 
        };
        // 发送给好友
